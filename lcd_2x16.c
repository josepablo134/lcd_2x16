 ...
 *		- EL RELOJ Y LAS FUNCIONES DE DELAY SE CONSIGUEN DEFININIENDO LAS CONSTANTES
 *			HZ Y CONFIG CON SUS RESPECTIVOS VALORES. OBSERVAR FUNCION SysCtlClockFreqSet
 *			TivaWareTM Peripheral Driver Library PAG(483).
